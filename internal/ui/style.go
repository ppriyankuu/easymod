...
func GetStyles() *Styles {
	...
	s.Banner = lipgloss.Place(
		...
		lipgloss.Center,
		lipgloss.Center,
		s.BannerContent.Render(s.BannerText.Render("easymod v.0.0.1")),
	...
	s.OptionsActiveItem = s.OptionsItem.Foreground(lipgloss.Color(ColorRed))
	...
	s.CommandModeActiveItem = s.CommandModeItem.Foreground(lipgloss.Color(ColorRed))
	...
	s.PathTypeActiveItem = s.PathTypeItem.Foreground(lipgloss.Color(ColorRed))
	...
	s.PermissionsActiveBlock = s.PermissionsBlock.BorderForeground(lipgloss.Color(ColorPurple))

	s.PermissionsBlockItem = lipgloss.NewStyle().PaddingLeft(2)

	s.PermissionsActiveBlockItem = s.PermissionsBlockItem.Foreground(lipgloss.Color(ColorRed))
